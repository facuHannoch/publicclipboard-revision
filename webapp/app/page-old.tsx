        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="rounded-full bg-slate-900 px-6 py-2 text-sm font-semibold text-white transition-all hover:scale-105 hover:bg-slate-800 dark:bg-slate-100 dark:text-slate-900 dark:hover:bg-slate-200"
            >
              Try Now
            </button>
          </div>
      ...
      <section className="relative flex min-h-screen flex-col items-center justify-center px-6 py-20 text-center">
        ...
        <div className="pointer-events-none absolute left-[5%] top-[20%] hidden lg:block">
          <div className="relative">
            {/* Desktop Board Frame */}
            <div className="h-48 w-80 rotate-6 rounded-lg border-2 border-slate-300 bg-slate-100/90 p-3 shadow-2xl backdrop-blur-sm dark:border-slate-700 dark:bg-slate-900/90">
              ...
              <div className="relative space-y-2">
                <div className="w-fit rounded-lg border-2 border-slate-300 bg-white p-2 shadow-sm dark:border-slate-600 dark:bg-slate-800">
                  <div className="h-1.5 w-24 rounded bg-slate-400 dark:bg-slate-500" />
                  <div className="mt-1 h-1.5 w-32 rounded bg-slate-400 dark:bg-slate-500" />
                </div>
                <div className="ml-8 w-fit rounded-lg border-2 border-slate-300 bg-white p-2 shadow-sm dark:border-slate-600 dark:bg-slate-800">
                  <div className="h-1.5 w-28 rounded bg-slate-400 dark:bg-slate-500" />
                  <div className="mt-1 h-1.5 w-20 rounded bg-slate-400 dark:bg-slate-500" />
                </div>
              </div>
              {/* Label */}
              <div className="absolute -bottom-8 left-1/2 -translate-x-1/2 whitespace-nowrap text-xs font-medium text-slate-500 dark:text-slate-400">
                💻 Desktop
              </div>
            </div>
          </div>
        ...
        <div className="pointer-events-none absolute bottom-[15%] right-[8%] hidden lg:block">
          <div className="relative">
            {/* Mobile Board Frame */}
            <div className="h-64 w-32 -rotate-3 rounded-2xl border-2 border-slate-300 bg-slate-100/90 p-2 shadow-2xl backdrop-blur-sm dark:border-slate-700 dark:bg-slate-900/90">
              {/* Board Grid Background */}
              <div
              ...
              <div className="relative space-y-2 p-1">
                <div className="w-fit rounded-lg border-2 border-slate-300 bg-white p-1.5 shadow-sm dark:border-slate-600 dark:bg-slate-800">
                  <div className="h-1 w-16 rounded bg-slate-400 dark:bg-slate-500" />
                  <div className="mt-1 h-1 w-20 rounded bg-slate-400 dark:bg-slate-500" />
                </div>
                <div className="ml-4 w-fit rounded-lg border-2 border-slate-300 bg-white p-1.5 shadow-sm dark:border-slate-600 dark:bg-slate-800">
                  <div className="h-1 w-14 rounded bg-slate-400 dark:bg-slate-500" />
                </div>
              </div>
              {/* Label */}
              <div className="absolute -bottom-8 left-1/2 -translate-x-1/2 whitespace-nowrap text-xs font-medium text-slate-500 dark:text-slate-400">
            ...
            <div className="absolute -right-16 top-12">
              <div className="relative rounded-2xl bg-slate-700 px-4 py-2 text-xs font-semibold text-white shadow-lg dark:bg-slate-300 dark:text-slate-900">
                Copied! ✓
                {/* Speech bubble arrow */}
                <div className="absolute left-0 top-1/2 h-0 w-0 -translate-x-1 -translate-y-1/2 border-b-[6px] border-r-[8px] border-t-[6px] border-b-transparent border-r-slate-700 border-t-transparent dark:border-r-slate-300" />
              </div>
            </div>
          </div>
        </div>
